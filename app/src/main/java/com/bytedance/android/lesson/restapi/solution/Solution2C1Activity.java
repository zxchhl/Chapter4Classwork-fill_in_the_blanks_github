...
public class Solution2C1Activity extends AppCompatActivity {
    ...
    public void requestData(View view) {
        ...
        retrofit.create(ICatService.class).randomCat().enqueue(new Callback<List<Cat>>() {
            @Override
        ...
        //String s = NetworkUtils.getResponseWithHttpURLConnection("https://api.thecatapi.com/v1/images/search?limit=5");
